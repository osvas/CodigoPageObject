...
public class SelectOnlyOneRateForTheJPYCurrencySteps {
	@Page
	...
	public void selectRatesOfTheJPYCurrency() {
		...
		firstScreen.screenShotsPage("listaDeTasas", "SeleccionarTasasMonedaYen");
		...
		do {
			...
			firstScreen.screenShotsPage("tasasSeleccionadasYenPagina" + numberOfPage, "SeleccionarTasasMonedaYen");
