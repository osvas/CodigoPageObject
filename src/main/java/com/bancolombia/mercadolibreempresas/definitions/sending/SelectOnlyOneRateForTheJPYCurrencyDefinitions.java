...
import com.bancolombia.mercadolibreempresas.steps.sending.SelectOnlyOneRateForTheJPYCurrencySteps;
...
public class SelectOnlyOneRateForTheJPYCurrencyDefinitions {
	@Steps
	private SelectOnlyOneRateForTheJPYCurrencySteps currencySteps;

	private String nit, idContigen1, idContigen2, idContigen3, nitType;

	@Before("@SelectOnlyOneRateForTheJPYCurrency")
	...
	public void selectRatesOfTheJPYCurrency() {
		currencySteps.selectRatesOfTheJPYCurrency();
	}

	@After("@SelectOnlyOneRateForTheJPYCurrency")
