...
public class TestShipmentByTheFundingBankWithMultipleRates {
	String shippingReference = "025060003408";
	String rate = "7402835.00";
	...
	public void getCodesFromCIBFFCONTR() {
		...
		bankNameInCIBFFCONTR = generalQueries.getTheNameOfTheBankInCIBFFCONTRMultipleRates(rate,
	...
	public void testValidateFileCIBFFCOMPL() {
		...
		assertTrue("Los códigos del archivo CIBFFCOMPL del banco no coinciden",
				bankCode.trim().equals(codesBankOfTheRate[0].trim()));
		assertTrue("Los subcódigos del archivo CIBFFCOMPL del banco no coinciden",
				bankSubCode.trim().equals(codesBankOfTheRate[1].trim()));
	}
	...
	public void testValidateFileCIBFFLGFND() {
		...
		assertTrue("Los códigos del archivo CIBFFLGFND del banco no coinciden",
				bankCode.trim().equals(codesBankOfTheRate[0].trim()));
		assertTrue("Los subcódigos del archivo CIBFFLGFND del banco no coinciden",
				bankSubCode.trim().equals(codesBankOfTheRate[1].trim()));
	}
